...
missouri = tibble::tribble(~`County`,	~`Yes`, ~`No`,	~`Rpt.`,
       ...
       "St. Louis City", "65,214", "8,556", "100",
       "Greene", "27,772", "25,343", "100",
        "Clay", "26,467", "18,008", "100",
            "Jefferson", "18,990", "22,063", "100",
                "Boone", "23,697", "11,891", "100",
            "Cass", "9,853", "11,850", "100",
               "Platte", "12,567", "7,810", "100",
        "Franklin", "7,409", "11,892", "100",
              "Cole", "7,407", "11,313", "100",
       "Cape Girardeau", "5,517", "11,756", "100",
               "Jasper", "5,779", "11,401", "100",
            "Christian", "5,656", "10,940", "100",
          "Buchanan", "6,988", "7,408", "100",
         "St. Francois", "5,274", "7,058", "100", 
       "Lincoln", "3,860", "7,903", "100",
          "Taney", "3,711", "7,141", "100",
               "Camden", "3,588", "7,227", "100",
          "Newton", "2,837", "7,645", "100",
            "Scott", "2,834", "6,074", "100",
               "Pettis", "3,318", "5,437", "100",
               "Phelps", "3,397", "5,357", "100",
          "Johnson", "3,559", "4,983", "100",
               "Howell", "2,624", "5,870", "100",
            "Stone", "2,663", "5,710", "100",
             "Callaway", "3,227", "5,056", "100",
               "Butler", "2,418", "5,823", "100",
             "Lawrence", "2,329", "5,583", "100",
          "Warren", "2,621", "5,117", "100",
                "Barry", "2,234", "5,388", "100",
              "Webster", "2,094", "4,982", "100",
        "Stoddard", "1,823", "4,961", "100",
            "Lafayette", "2,836", "3,889", "100",
              "LaClede", "1,816", "4,890", "100",
                 "Polk", "1,988", "4,178", "100",
              "Pulaski", "1,836", "4,274", "100",
               "Miller", "1,573", "4,159", "100",
                "Texas", "1,632", "4,045", "100",
            "Marion", "1,672", "3,454", "100",
                "Adair", "1,941", "3,034", "100",
               "Vernon", "1,786", "3,124", "100",
             "Randolph", "1,521", "3,286", "100",
               "Andrew", "1,650", "3,117", "100",
          "Wright", "1,064", "3,598", "100",
              "Nodaway", "1,935", "2,666", "100",
                "Henry", "1,887", "2,698", "100",
             "Crawford", "1,484", "3,015", "100",
          "Clinton", "1,819", "2,644","100",
           "Washington", "1,607", "2,799", "100",
              "Dunklin", "1,322", "3,042", "100",
                 "Pike", "1,517", "2,832", "100",
                  "Ray", "1,846", "2,502", "100",
               "Benton", "1,514", "2,827", "100",
                "Perry", "1,214", "3,113", "100",
            "Gasconade", "1,334", "2,949", "100",
           "Livingston", "1,244", "2,985", "100",
               "Cooper", "1,423", "2,752", "100",
              "Douglas", "1,135", "2,984", "100",
                 "Dent", "1,229", "2,836", "100",
             "McDonald", "1,150", "2,911", "100",
               "Morgan", "1,285", "2,677", "100",
       "Ste. Genevieve", "1,735", "2,204", "100",
              "Audrain", "1,426", "2,434", "100",
               "Saline", "1,809", "2,033", "100",
                "Bates", "1,285", "2,246", "100",
               "Barton", "686", "2,768", "100",
             "Moniteau", "782", "2,614", "100",
                "Cedar", "931", "2,416", "100",
                "Osage", "762", "2,580", "100",
               "Dallas", "935", "2,402", "100",
            "Bollinger", "719", "2,369", "100",
           "Montgomery", "994", "2,084", "100",
                "Wayne", "801", "2,268", "100",
                "Ozark", "897", "2,149", "100",
                "Macon", "735", "2,304", "100",
                "Ralls", "846", "2,112", "100",
               "Ripley", "921", "1,899", "100",
            "St. Clair", "931", "1,811", "100",
                 "Linn", "858", "1,805", "100",
           "New Madrid", "898", "1,740", "100",
             "Caldwell", "856", "1,734", "100",
          "Mississippi", "892", "1,660", "100",
              "Shannon", "909", "1,578", "100",
               "Oregon", "860", "1,609", "100",
               "Howard", "895", "1,487", "100",
              "Hickory", "725", "1,570", "100",
               "DeKalb", "630", "1,628", "100",
              "Madison", "755", "1,490", "100",
               "Monroe", "638", "1,599", "100",
               "Maries", "581", "1,655", "100",
             "Pemiscot", "762", "1,462", "100",
                 "Dade", "503", "1,590", "100",
               "Grundy", "537", "1,544", "100",
              "Carroll", "630", "1,413", "100",
             "Reynolds", "700", "1,257", "100",
              "Daviess", "599", "1,337", "100",
             "Chariton", "550", "1,312", "100",
             "Harrison", "495", "1,292", "100",
               "Gentry", "726", "1,033", "100",
             "Atchison", "546", "1,080", "100",
               "Shelby", "412", "1,189", "100",
               "Carter", "493", "1,090", "100",
                "Lewis", "377", "1,184", "100",
                "Clark", "402", "1,000", "100",
             "Scotland", "438", "765", "100",
                 "Holt", "355", "810", "100",
             "Sullivan", "218", "786", "100",
                 "Knox", "237", "666", "100",
               "Mercer", "186", "674", "100",
               "Putnam", "171", "628", "100",
             "Schuyler", "220", "555", "100",
                "Worth", "220", "455", "100",
                 "Iron", "64", "70", "100"
  )

mo_dt = missouri %>%
  select(County, Yes, No) %>%
  rename(votes_for = Yes) %>%
  rename(votes_against = No) %>%
  rename(county = County) %>%
  mutate(state = "Missouri") %>%
  mutate(elec_date = "8/04/2020") %>%
  mutate(votes_for = gsub(",", "", votes_for)) %>%
  mutate(votes_against = gsub(",", "", votes_against)) %>%
  mutate(votes_for = as.numeric(votes_for)) %>%
  mutate(votes_against = as.numeric(votes_against)) %>%
  mutate(total_votes = votes_for + votes_against) %>%
  mutate(share_for = (votes_for / total_votes) * 100) %>%
  mutate(share_against = (votes_against / total_votes) * 100)
...
aca_refs$share_for <= 100
aca_refs$share_against <= 100
